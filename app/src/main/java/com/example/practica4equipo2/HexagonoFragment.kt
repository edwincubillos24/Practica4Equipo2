...
import kotlinx.android.synthetic.main.fragment_hexagano.*
import kotlin.math.sqrt

class HexagonoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_hexagano, container, false)
    }
